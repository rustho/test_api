 ...
 * no description
 */
export class InternalCPTApiRequestFactory extends BaseAPIRequestFactory {
     ...
     * @param REQUEST_TOPIC 
     */
    public async internalCptControllerImport(url: string, REQUEST_SOURCE: any, REQUEST_TOPIC: any, _options?: Configuration): Promise<RequestContext> {
        let _config = _options || this.configuration;

        // verify required parameter 'url' is not null or undefined
        if (url === null || url === undefined) {
            throw new RequiredError("InternalCPTApi", "internalCptControllerImport", "url");
        }


        // verify required parameter 'REQUEST_SOURCE' is not null or undefined
        if (REQUEST_SOURCE === null || REQUEST_SOURCE === undefined) {
            throw new RequiredError("InternalCPTApi", "internalCptControllerImport", "REQUEST_SOURCE");
        }


        // verify required parameter 'REQUEST_TOPIC' is not null or undefined
        if (REQUEST_TOPIC === null || REQUEST_TOPIC === undefined) {
            throw new RequiredError("InternalCPTApi", "internalCptControllerImport", "REQUEST_TOPIC");
        }


        // Path Params
        const localVarPath = '/api/v1/internal/cpt/import';
...
export class InternalCPTApiResponseProcessor {

    /**
     * Unwraps the actual response sent by the server from the response context and deserializes the response content
     * to the expected objects
     *
     * @params response Response returned by the server for a request to internalCptControllerImport
     * @throws ApiException if the response code was not in [200, 299]
     */
     public async internalCptControllerImport(response: ResponseContext): Promise<InternalCptControllerImport200Response > {
